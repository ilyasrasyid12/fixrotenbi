...
<body class="">
  ...
  <!--hero section-->
  <section class=" flex justify-center align-middle h-[100vh]" data-aos="fade-up">
    <div class="grid grid-cols-1 lg:grid-cols-3 w-full relative ">
      ...
      <div class="text-wrapper absolute lg:relative flex flex-col lg:justify-end bottom-0 w-full text-center gap-2  ">
        ...
        <!-- title 2 -->
        <h3 class="text-xl lg:text-2xl lg:absolute lg:bottom-28 lg:-left-1/4 z-10 order-3" data-translate="hero3">Tas anyaman & Hadiah Perusahaan
        </h3>
        <!-- button -->
        <div class="flex justify-center mt-4 z-10 pb-5">
          <a href="#produk-kami" class="scroll-link">
            <button class="px-4 py-2 bg-primary text-white rounded hover:bg-opacity-80" data-translate="button-see">Lihat Selengkapnya</button>
          </a>
        </div>
      </div>
      <div class="img-wrapper relative">
        <img src="./assets/images/hero-1.webp" alt="R" class="w-full h-full object-cover"></div>
    </div>
  </section>
  ...
  <section class="flex relative mx-2 lg:mx-24 gap-3 mt-10 flex-col-reverse lg:flex-row" data-aos="fade-up">
    <div class="text-wrapper justify-center flex flex-col text-center lg:text-start gap-5 lg:gap-2">
      ...
      <p class="text-secondary md:w-4/5" data-translate="index-about-p">Menganyam merupakan proses menjalin bilah secara tindih menindih,silang menyilang membentuk suatu jalinan yang indah dan unik. Kegiatan menganyam menjadi kegiatan rutin yang dilakoni para perajin di Rotenbi</p>
    </div>
  ...
  <section id="produk-kami" class="mx-2 lg:mx-24  mt-10 relative" data-aos="fade-up">
    ...
    <div class="content-wrapper flex flex-col lg:flex-row gap-5 relative w-full mt-5">
      <div class="img-wrapper flex-shrink-0 h-auto relative lg:w-[30vw] ">
        <img src="./assets/images/produk-main.webp" alt="produk rotenbi" class="w-full h-full object-cover" loading="lazy">
      </div>
      <div class="w-full ">
        <section id="looping">
          <div class="wrapper">
            <div class="itemLeft item1"><img src="./assets/images/produk-1.webp" alt="produk rotenbi" loading="lazy"></div>
            <div class="itemLeft item2"><img src="./assets/images/produk-2.webp" alt="produk rotenbi" loading="lazy"></div>
            <div class="itemLeft item3"><img src="./assets/images/produk-3.webp" alt="produk rotenbi" loading="lazy"></div>
          </div>
          <div class="wrapper">
            <div class="itemRight item1"><img src="./assets/images/produk-4.webp" alt="produk rotenbi" loading="lazy"></div>
            <div class="itemRight item2"><img src="./assets/images/produk-5.webp" alt="produk rotenbi" loading="lazy"></div>
            <div class="itemRight item3"><img src="./assets/images/produk-6.webp" alt="produk rotenbi" loading="lazy"></div>
          </div>
        </section>
  ...
  <section class="relative mt-7" data-aos="fade-up">
    <div class="img-wrapper relative w-full h-[230px] md:h-[450px]">
      <div class="text-wrapper absolute text-white z-10 w-3/4 md:w-1/2 top-1/2 -translate-y-1/2 mx-3">
        ...
        <p class="text-stone-200 text-xs lg:text-base" data-translate="empowers">Rotenbi memberdayakan perajin lokal yang dididik khusus menyesuaikan standar kualitas, untuk memperbaiki ekonomi mereka dan kapasitas mereka sebagai perajin dan juga sebagai bentuk partisipasi Rotenbi meningkatkan ekonomi lokal.</p>
      </div>
  ...
  <section class="mx-2 lg:mx-24 mt-10 md:mt-16" data-aos="fade-up">
    <div class="grid grid-cols-12">
      ...
      <h2 class="col-span-8 sm:col-span-4 text-4xl text-center text-primary font-bold w-full flex-shrink-0 uppercase mb-4" data-translate="impact">DAMPAK </h2>
      <div class="col-span-2 sm:col-span-4 h-line w-full  h-full flex items-center justify-center">
        <div class="line w-full bg-primary h-[2px]"></div>
      </div>
    </div>
  ...
  <section class="mx-2 lg:mx-24 mt-8 md:mt-16" data-aos="fade-up">
    <div class="flex flex-col md:flex-row items-center gap-4 pb-1">
      ...
      <div class="flex flex-col justify-center text-black md:ml-20 md:w-1/3">
        ...
        <p class="text-secondary" data-translate="smile-p"> Rotenbi dapat menciptakan senyum untuk mereka para yang terlibat pada proses kami, sehingga anak-anak dari para perajin kami dapat melanjutkan pendidikannya dengan baik.
        </p>
      </div>
    </div>
  </section>
  ...
  <section class="mx-2 lg:mx-24 mt-10 md:mt-16" data-aos="fade-up">
    <div class="grid grid-cols-1 md:grid-cols-2">
      <h2 class="text-3xl sm:text-4xl w-full font-legular text-black" data-translate="partnership">Informasi Kemitraan & Pelatihan </h2>
      <p class="text-secondary" data-translate="partnership-p">Kami membuka peluang untuk kemitraan dan menyediakan pelatihan berkualitas bagi Anda yang ingin berkembang bersama kami. Jika Anda memiliki pertanyaan atau membutuhkan informasi lebih lanjut, jangan ragu untuk menghubungi kami melalui kontak berikut:</p>
    </div>
  ...
  <section class="relative mt-7" data-aos="fade-up">
    <div class="img-wrapper relative w-full h-[230px] md:h-[450px]">
      <div class="text-wrapper absolute text-white z-10 w-3/4 md:w-1/2 top-1/2 -translate-y-1/2 mx-3">
        <h3 class="font-bold lg:text-3xl uppercase" data-translate="thanks">TERIMAKASIH TELAH MENDUKUNG PEMBERDAYAAN KAMI</h3>
      </div>
      <div class="gradient absolute w-full h-full bg-gradient-to-r from-black"></div>
      ...
      <!--whatsapp pojok kanan bawah-->
  <div class="fixed bottom-6 right-6 z-50">
  <a href="https://wa.me/+6281234567890" target="_blank" class="block bg-green-500 rounded-full p-2 hover:bg-green-600 transition-all duration-300 hover:scale-110">
    <img src="./assets/svg/whatsapp.svg" alt="WhatsApp Rotenbi" class="w-8 h-8">
  </a>
</div>
